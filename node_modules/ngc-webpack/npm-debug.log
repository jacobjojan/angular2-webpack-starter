...
1 verbose cli   'run',
1 verbose cli   'build:aot:prod' ]
2 info using npm@3.10.3
3 info using node@v6.4.0
4 verbose stack Error: missing script: build:aot:prod
...
5 verbose cwd /Users/develop/Documents/code/angular2/v1/angular2-webpack-starter/node_modules/ngc-webpack
6 error Darwin 16.3.0
7 error argv "/usr/local/bin/node" "/usr/local/bin/npm" "run" "build:aot:prod"
8 error node v6.4.0
9 error npm  v3.10.3
10 error missing script: build:aot:prod
